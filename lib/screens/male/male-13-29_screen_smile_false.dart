...
class MaleThirteenToTwentyNineSmileFalse extends StatelessWidget {
  final String ageGroup;
  final String gender;

  const MaleThirteenToTwentyNineSmileFalse({Key? key, required this.ageGroup, required this.gender}) : super(key: key);
