...
class FemaleThirteenToTwentyNineAngry extends StatelessWidget {
  final String ageGroup;
  final String gender;

  const FemaleThirteenToTwentyNineAngry({Key? key, required this.ageGroup, required this.gender}) : super(key: key);
